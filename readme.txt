...
Donate link:  http://www.webdirexion.com/plugins/
Requires at least: 3.1
Tested up to: 3.2.1
Stable tag: 2.1

MaxRef Widgets, from Webdirexion LLC, is a Content Marketing plugin that enables you to display multiple sidebar widgets to maximize how your visitors reference your posts, links, categories and comments.
...
Changes: Visit us at http://www.webdirexion.com/plugins/ for news and updates
...
Please see official page to read Q & A, make comments and post new questions: http://www.webdirexion.com/plugins/

== Screenshots ==
1. New Tab to set MaxRef Widgets to display in selected blog categories only

2. MaxRef Widgets displays page parent and child group on sidebars

3. MaxRef Widgets child group with title link on sidebars
...
== Support & Suggestions ==
We offer screenshots, and instructions, plus welcome your suggestions at: http://www.webdirexion.com/plugins/
...
version 2.0 released October 6, 2011
